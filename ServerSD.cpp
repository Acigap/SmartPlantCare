...
void startWifiServer() {
    ...
    server.on("/veggieSelection", []() {
        ...
        html += "<option value='0'>ผักชี</option>";
        html += "<option value='1'>กะเพรา</option>";
        html += "<option value='2'>โหระพา</option>";
        html += "<option value='3'>ผักกาดขาว</option>";
        html += "<option value='4'>ผักบุ้ง</option>";
        html += "<option value='5'>คะน้า</option>";
        html += "<option value='6'>ต้นหอม</option>";
        html += "<option value='7'>ผักกาดหอม</option>";
        html += "<option value='8'>ผักกาดแก้ว</option>";
        html += "<option value='9'>แตงกวา</option>";
        html += "<option value='10'>พริก</option>";
        html += "</select><br>";
